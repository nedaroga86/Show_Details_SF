...
def show_opportunity_source_table():
    ...
    st.dataframe(filtered_data[['Opportunity ID', 'Opportunity Number', 'Opportunity.Acount Name','Stage Name', 'Name', 'Stage', 'Created Dates','Close Dates','Amount']], use_container_width =True, hide_index=True, height=700)
